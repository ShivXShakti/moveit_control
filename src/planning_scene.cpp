...
static const std::string PLANNING_GROUP_L = "arm_left";
static const std::string PLANNING_GROUP_R = "arm_right";
...
auto traj_pubr = move_group_node->create_publisher<trajectory_msgs::msg::JointTrajectory>(
    ...
    for (size_t i = 0; i < trajl.points.size() && rclcpp::ok(); ++i) {
